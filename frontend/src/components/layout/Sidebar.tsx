...
const NAV: NavItem[] = [
  ...
  { to: ROUTES.NGANH_HOC,       label: 'Ngành học',        Icon: IconBuildingCommunity, roles: ['admin', 'phong-dao-tao'] },
  { to: ROUTES.KHOA,            label: 'Khoa',             Icon: IconBuildingSkyscraper, roles: ['admin', 'phong-dao-tao'] },
